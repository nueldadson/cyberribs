...
const Hero = () => {
	...
	const sliderContent = [
		{
			image: hero1,
			heading: "CyberRibs",
			writeup: "Augmented &<br/>Virtual Reality",
		},
		{
			image: hero,
			heading: "CyberRibs",
			writeup: "We always<br/>aim for the<br/>best.",
		},
	...
	return (
		<div
			className="px-8 max-sm:p-4 bg flex rounded-[30px] min-h-[430px]"
		...
		>
			<AwesomeSlider
				...
				buttons={false}
				mobileTouch={false}
				className="w-full rounded-[30px] overflow-hidden bg-transparent min-h-[430px]"
				style={{ height: "calc(100vh - 80px)" }}
				infinite
			>
				{sliderContent.map((slide, index) => (
					<div
						key={index}
						className="w-full rounded-[30px] px-12 max-sm:px-4 h-full"
						style={{
							minHeight: "430px",
					...
					>
						<div className="flex-col gap-2 mt-28 herotxtH max-sm:mt-[150px]">
							<span
								className="text-[#c084fc] font-extrabold tracking-widest"
								style={{ textShadow: "1px 1px 2px black" }}
							>
								{slide.heading}
							</span>
							<p
								className="text-white text-[54px] max-[500px]:text-[46px] max-[363px]:text-[34px] leading-none font-semibold -mt-1"
